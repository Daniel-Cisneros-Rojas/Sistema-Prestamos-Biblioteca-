          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              ...
              if (isset($_SESSION['autenticado']) && $_SESSION['autenticado'] === true) {
                  ...
                  echo '<li class="nav-item"><a class="nav-link" href="iniciar_sesion.php"><i class="fa fa-user" aria-hidden="true"></i> Iniciar sesión <span class="sr-only">(current)</span></a></li>';
                  echo '<li class="nav-item active"><a class="nav-link" href="registrar_usuario.php"><i class="fa fa-user" aria-hidden="true"></i> Registrarse</a></li>';
              }
    ...
    <div class="service_container">
      <div class="container ">
        <div class="heading_container heading_center">
          ...
          <p>
            Complete el siguiente formulario para crear una cuenta nueva.
          </p>
        </div>

        <div class="row justify-content-center">
          <div class="col-md-8">
            <form action="validar_usuario.php" method="post" class="bg-light p-4 rounded shadow-sm">
              ...
              <div class="btn-box mt-4 d-flex flex-wrap gap-2">
                <button type="submit" class="btn1"style="background-color: #00bbf0; color: #fff; padding: 10px 45px; border: none;" >Registrarse</button>
			  ...
			  <?php
				if (isset($_SESSION['error_registro_usuario'])) {
   		 		echo '<div class="alert alert-danger mt-3" role="alert" style="background-color: #ffcccc; color: #a94442; padding: 10px; border-radius: 5px;">' . $_SESSION[	'error_registro_usuario'] . '</div>';
    unset($_SESSION['error_registro_usuario']);
}
?>
