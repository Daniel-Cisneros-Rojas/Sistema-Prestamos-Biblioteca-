...
<head>
  ...
  <script LANGUAGE="JavaScript">
    function confirmSubmit() {
      var eli=alert("Este libro no esta disponible");
      if (eli) return true ;
      else return false ;
    }
  </script>
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              ...
              ?>
              <li class="nav-item active"><a class="nav-link" href="ver_libros.php">Ver libros</a></li>
      ...
      <div class="container ">
        ...
        <div class="table-responsive">
          ...
          if ($resultado->num_rows > 0) {
              ...
              echo "<thead class='bg-primary text-white'><tr><th>ID</th><th>Título</th><th>Autor</th><th>Editorial</th><th>Año</th><th>Descripción</th><th>Imagen</th><th>Estado</th><th>Solicitar prestamo</th></tr></thead><tbody>";
              ...
              while ($fila = $resultado->fetch_assoc()) {
                  ...
                  echo "<td><img src='" . $fila['imagen'] . "' alt='Imagen del libro' width='150' height='250'></td>";
                  echo "<td>" . $fila['estado'] . "</td>";

                  if($fila['estado'] == 'disponible'){
                      echo "<td><a onclick='return verificarSesion()' href='solicitar_prestamo.php?id=" . $fila['id'] . "'><img src='imagenes/check.png' alt='Imagen de check' width='100' height='100'></a></td>";
                  } else {
                      echo "<td><a onclick='return confirmSubmit()' href='ver_libros.php'><img src='imagenes/no_disponible.png' alt='Imagen de check' width='100' height='100'></a></td>";
                  }
                  echo "</tr>";
              }
              echo "</tbody></table>";
          } else {
              echo "<p class='text-center mt-4'>No hay libros disponibles.</p>";
          }
          ?>
        </div>
